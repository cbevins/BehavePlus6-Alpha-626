...
private:
    VarCheckBox *addOutput( PropertyPage *page,
                ...
                bool wrapped=false ) ;
    void containInputOptions( void ) ;
    void containOutputOptions( void ) ;
    void crownInputOptions( void ) ;
    void crownOutputOptions( void ) ;
    void ignitionOutputOptions( void ) ;
    void mortalityOutputOptions( void ) ;
    void scorchInputOptions( void ) ;
    void scorchOutputOptions( void ) ;
    void safetyOutputOptions( void ) ;
    void sizeOutputOptions( void ) ;
    void spotOutputOptions( void ) ;
    void surfaceInputOptions( void ) ;
    void surfaceOutputOptions( void ) ;
    void weatherOutputOptions( void ) ;
...
private:
    ...
    QPushButton  **m_pb2;           //!< Array of pointers to module option buttons
