#ifndef BP6_CHAPARRAL_FUEL_CHAMISE_H
#define BP6_CHAPARRAL_FUEL_CHAMISE_H

#include "Bp6ChaparralFuel.h"

/*!	\class Bp6ChaparralFuelChamise
 ...
 *
 *	\par Usage
	// Step 1 - create the chaparral chamise fuel object
	Bp6ChaparralFuelChamise* cf = new Bp6ChaparralFuelChamise();
 ...
 */
class Bp6ChaparralFuelChamise : public Bp6ChaparralFuel
{
public:
	Bp6ChaparralFuelChamise();
	virtual ~Bp6ChaparralFuelChamise();
...
#endif	// BP6_CHAPARRAL_FUEL_CHAMISE_H
