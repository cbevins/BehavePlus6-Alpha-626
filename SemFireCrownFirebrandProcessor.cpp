/*!	\file SemFireCrownFirebrandProcessor.cpp
	\brief Sem::Fire::Crown::Firebrand::Processor class definition
*/
...
*/
Sem::Fire::Crown::Firebrand::Processor::Processor(
		double canopyHt,
		double fireInt,
		double windSpeed,
		double windHt,
...
//------------------------------------------------------------------------------
void Sem::Fire::Crown::Firebrand::Processor::process()
{
	reset();
...
/*!	\brief Adjusts the input wind speed measured at the input anemometer height
	...
	utop = uan / ( 3.6 * fact )
*/
void Sem::Fire::Crown::Firebrand::Processor::processCanopyWindSpeed()
{
	double factor = 1.;
	if ( m_canopyHt > 0.1 )
	{
...
*/
void Sem::Fire::Crown::Firebrand::Processor::processFirebrandDrift()
{
...
*/
void Sem::Fire::Crown::Firebrand::Processor::processFirebrandLoft()
{
...
*/
void Sem::Fire::Crown::Firebrand::Processor::processFlameBoundaryConditions()
{
...
*/
void Sem::Fire::Crown::Firebrand::Processor::processFlameHeight()
{
...
*/
void Sem::Fire::Crown::Firebrand::Processor::reset()
{
	m_canopyWind = 0.;
	m_flameHt    = 0.;
	m_loftHt     = 0.;
...
/*!	\brief Resets all the input properties.
	...
	\param deltaStep Plume layer slice size (default = 0.2 m)
*/
void Sem::Fire::Crown::Firebrand::Processor::set(
		double canopyHt,
		double fireInt,
		double windSpeed,
		double windHt,
...
/*!	\brief Sets the mean canopy height at the top of the canopy of an active crown fire.
	\param canopyHt Mean canopy height at the top of the canopy of an active crown fire (m).
*/
void Sem::Fire::Crown::Firebrand::Processor::setCanopyHeight( double canopyHt )
{
...
*/
void Sem::Fire::Crown::Firebrand::Processor::setDeltaStep( double deltaStep )
{
...
/*!	\brief Sets the diameter of a viable firebrand ember when it alights at the fuel surface.
	...
	the fuel surface (mm).
*/
void Sem::Fire::Crown::Firebrand::Processor::setEmberDiameter( double emberDiam )
{
...
/*!	\brief Sets the active crown fireline intensity (kW/m).
	\param fireInt Active crown fireline intensity (kW/m).
*/
void Sem::Fire::Crown::Firebrand::Processor::setFirelineIntensity( double fireInt )
{
...
*/
void Sem::Fire::Crown::Firebrand::Processor::setWindSpeed( double windSpeed )
{
...
*/
void Sem::Fire::Crown::Firebrand::Processor::setWindSpeedHeight( double windSpeedHt )
{
...
*/
void Sem::Fire::Crown::Firebrand::Processor::update()
{
	if ( m_isDirty )
	{
		process();
