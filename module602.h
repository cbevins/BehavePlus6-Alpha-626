...
public:
    Module( const QString &name, const QString &textKey, const QString sort,
        int indent, int releaseFrom, int releaseThru, bool inputs, bool outputs ) ;
...
public:
	...
	bool    m_inputs;		//!< If TRUE, displau inputs options button
	bool    m_outputs;		//!< If TRUE, displau outputs options button
};
