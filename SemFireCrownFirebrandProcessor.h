/*!	\file SemFireCrownFirebrandProcessor.h
	\brief Sem::Fire::Crown::Firebrand::Processor class declaration
*/
...
{
public:
	Processor( double canopyHt=0., double fireInt=0., double windSpeed=0.,
