...
/*! \file ContainSim6.h
    ...
    2   The ContainForce6 Class is the collection of all ContainResource6 instances
...
#ifndef _CONTAINSIM6_H_INCLUDED_
#define _CONTAINSIM6_H_INCLUDED_
...
public:
    ...
    ContainSim6(
        ...
        double lwRatio=1.,
        ContainForce6 *force=0,
        Contain6::ContainTactic6 tactic=Contain6::HeadAttack6,
        double attackDist=0.,
        bool retry=true,
        int minSteps=250,
        int maxSteps=1000,
    ...
    Contain6::ContainStatus6 status( void ) const ;
    Contain6::ContainTactic6 tactic( void ) const ;
	...
	double UncontainedArea( double head, double lwRatio, double x, double y,
		Sem::Contain6::ContainTactic6 tactic  );	 // By DT 1/2013 WFIPS
...
public:
    ...
    Contain6 *m_left;       //!< Left flank Contain object.
    Contain6 *m_right;      //!< Right flank Contain object.
    ContainForce6 *m_force; //!< Containment forces for both flanks
