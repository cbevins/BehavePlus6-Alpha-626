    ...
    m_modules(0)
{
	...
	translate( buttonLabel, "ModulesDialog:Option:Options:Label" );
          ...
          mod = m_moduleList->next() )
    {
        ...
        widgetName = "m_" + mod->m_name + "PushButtonOptions";
...
void ModulesDialog::surfaceOptions( void )
{
    ...
    // Add the "Fuel & Moisture" page 1
    p = dialog->addPage( "PropertyTabDialog:Surface:FuelMoisture:Tab",
    ...
    bg->setFixedHeight( bg->sizeHint().height() );
    // Add the "Fuel & Moisture" page 1
    // "Dynamic curing load transfer is" button group
    ...
    //              r, 1, r, 1 ); r++;
    addOutput( p, "surfaceCalcDirectionVariables",
                  "vSurfaceFireDirectionVariables",
                  r, 0, r, 1 ); r++;
